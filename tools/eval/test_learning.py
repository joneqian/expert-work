"""Unit tests for the J.12 learning eval — Stream J.12-step4 closeout."""
...
def test_load_cases_parses_twenty_one() -> None:
    cases = load_cases(_EVAL_DIR / "datasets" / "learning" / "m0_baseline.yaml")
    assert len(cases) == 21
...
async def test_unknown_scenario_marks_case_failed() -> None:
    ...
    case = LearningEvalCase(case_id="bogus", scenario="not_a_scenario")
