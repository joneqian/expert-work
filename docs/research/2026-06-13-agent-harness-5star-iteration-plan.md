...
10.1(2) 10.5(3) 11.3(3) 11.4(1) 11.5(2) 11.6(2) 12.4(3) 13.1(✅) 13.2(3) 14.4(3) 16.3(3) 16.4(3)
...
- **注**：价值口径下 P1/P2 含 L/XL 大件（trace 实装、HA），排前是因价值高非好做。若要早见效，P1 内可先做小而高杠杆的 11.3/11.5/1.3，trace(10.1)+HA(9.4/9.5) 并行另起人手。
- **已定决策（2026-06-13）**：
