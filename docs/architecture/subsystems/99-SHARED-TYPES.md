...
- 子系统 doc 通过 `from helix.types import EventType` 等方式引用
...
```
packages/helix-protocol/src/helix/types/
├── __init__.py
├── events.py          # EventType
...
```python
# packages/helix-protocol/src/helix/types/events.py
...
```python
# packages/helix-protocol/src/helix/types/audit.py
from enum import StrEnum
...
```python
# packages/helix-protocol/src/helix/types/isolation.py
from enum import StrEnum
...
```python
# packages/helix-protocol/src/helix/types/state.py
from enum import StrEnum
...
```python
# packages/helix-protocol/src/helix/types/aliases.py
...
```python
from helix.types import ComplianceLevel, IsolationLevel
