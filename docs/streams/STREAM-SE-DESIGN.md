...
|---|---|---|
| D | 本设计 | — |
| 1 | SE-A46 打标入口(Playground 👍/👎 + comment 框,接现成端点)——试点信号主力,先行 | D |
| 2 | SE-A40 重试档 + SE-A41 灰度(小而独立,解锁 live 试点) | D |
| 3 | SE-A38/A39/A44 信号扩容(classify 升级 + EVOLVE_SIGNALS + failures 注入 + 弱信号禁 auto) | 2 |
| 4 | SE-A45 judge 抽样评分(候选提纯,tenant_config 抽样率) | 3 |
| 5 | SE-A42 auto_attach_evolved_skills(spec 字段 + build 装配 + 表单/i18n) | 2 |
| 6 | SE-A43 aux 计量 | 2 |
| 7 | SE-A47 入库查重(embedding 相似 → 转修订轮) | 3 |
| 8 | promote 事件发射(触达渠道另立项) | 5 |
