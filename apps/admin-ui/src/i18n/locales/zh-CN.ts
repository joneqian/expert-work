...
const zhCN: TranslationKeys = {
  ...
  user_profile: {
    ...
    purge_self_warning: "这是你自己账号的数据 —— 清除后你自己的对话 · 记忆 · 工作区将被删除,且不可撤销。",
  ...
  agents_page: {
    ...
    action_enable: "启用",
    delete_title: "删除智能体",
    delete_warning: "此操作将删除「{{name}}」v{{version}},且无法通过界面恢复。",
    delete_warning_desc: "标记为已删除状态(软删除);不影响该智能体的其它版本。",
    delete_type_to_confirm: "输入智能体名称确认删除:",
    delete_success: "已删除「{{name}}」v{{version}}",
    delete_failed: "删除失败:{{error}}",
    disable_confirm_title: "停用该智能体?",
    disable_confirm_body:
      "将拒绝「{{name}}」所有版本的新运行与会话,并取消正在运行中的 run。可随时重新启用。",
    disable_success: "已停用「{{name}}」,取消了 {{count}} 个运行中的 run",
    disable_failed: "停用失败:{{error}}",
    enable_success: "已启用「{{name}}」",
    enable_failed: "启用失败:{{error}}",
    create: "新建",
    from_template: "从模板创建",
  },
  create_agent: {
