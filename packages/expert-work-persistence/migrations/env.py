...
1. ``EXPERT_WORK_DB_URL`` env var (preferred — set by deploy scripts / tests)
...
from expert_work.persistence.models import AuditLogRow, EventLogRow, ThreadMetaRow  # noqa: F401
