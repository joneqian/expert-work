...
# Modifications:
#   - Reshaped interface to match Expert Work ADR-0002 schema:
...
Implementations:
- :class:`expert_work.runtime.event_log.memory.InMemoryEventStore` — tests
- :class:`expert_work.runtime.event_log.db.DbEventStore` — production (Postgres)
"""
